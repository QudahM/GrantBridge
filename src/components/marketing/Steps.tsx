...
const steps = [
  {
    ...
    description: "Tell us about your education, background, and funding needs in just 5 minutes"
  },
  {
    icon: Sparkles,
    number: "02",
    title: "Get Matched",
    description: "Our AI analyzes thousands of grants and shows you the best opportunities"
  },
  {
    icon: Send,
    number: "03",
    title: "Apply with Confidence",
    description: "Use our AI assistant to craft compelling applications that stand out"
  }
];
      ...
      >
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-slate-300 max-w-2xl mx-auto">
            From profile creation to application submission, we guide you every step of the way
          </p>
        </div>
