        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-slate-300 max-w-2xl mx-auto">
              We'd love to hear from you! Share feedback, report issues, or get
              help.
            </p>
          </motion.div>
          ...
          {success && (
            <motion.div
              ...
              className="mb-8"
            >
              <Alert className="bg-gradient-to-r from-emerald-500/10 to-green-500/10 border-emerald-500/30 text-emerald-300">
                <CheckCircle size={16} />
